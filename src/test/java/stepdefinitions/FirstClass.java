...
public class FirstClass {
    ...
    public void kullanici_api_demos_tiklasin() throws InterruptedException {
        Thread.sleep(2000);
    ...
    @When("kullanici kutuya yazi gondersin {string}")
    public void kullanici_kutiya_yazi_gondersin(String string) {
        elements.preferenceDependenciesPage().textBox.sendKeys("test");
