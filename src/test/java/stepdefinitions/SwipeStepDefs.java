...
public class SwipeStepDefs {
    ...
    public void kullanici_date_widgets_tiklasin() {
        elements.viewPage().dateWidgets.click();
    }
    ...
    public void kullanici_ten_kaydiracak(Integer sayi1, Integer sayi2) {
        TouchAction touchAction= new TouchAction(Driver.getAppiumDriver());
        touchAction.press(ElementOption.element(elements.dateWidgetsPage().num15)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1)))
